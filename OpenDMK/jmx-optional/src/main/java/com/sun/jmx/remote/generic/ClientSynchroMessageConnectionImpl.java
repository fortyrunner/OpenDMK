...
public class ClientSynchroMessageConnectionImpl implements ClientSynchroMessageConnection {
  ...
  public void connect(Map env) throws IOException {
    synchronized (stateLock) {
      if (state == UNCONNECTED) {
        ...
        if (state == FAILED || state == CONNECTED) { // reconnect
          if (logger.traceOn()) {
          ...
          synchronized (waitingList) {
            for (Object o : waitingList.keySet()) {
              Long id = (Long) o;
      ...
      if (msg instanceof MBeanServerRequestMessage) {
        ...
        while (true) {
          ...
          if (mwrapper.msg instanceof MBeanServerResponseMessage) {
            ...
            if (mwrapper.msg instanceof ConnectionClosedException) {
  ...
  public void close() throws IOException {
    ...
    synchronized (stateLock) {
      ...
      synchronized (waitingList) {
        for (Object o : waitingList.values()) {

          ResponseMsgWrapper rm = (ResponseMsgWrapper) o;
