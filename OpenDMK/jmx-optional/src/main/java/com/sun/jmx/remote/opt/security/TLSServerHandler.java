...
public class TLSServerHandler implements ProfileServer {
  ...
  static {
    ...
    try {
      getProtocol =
        SSLSession.class.getMethod("getProtocol");
      getEnabledProtocols =
        SSLSocket.class.getMethod("getEnabledProtocols");
      setEnabledProtocols =
        SSLSocket.class.getMethod(
          "setEnabledProtocols",
          String[].class);
      getWantClientAuth =
        SSLSocket.class.getMethod("getWantClientAuth");
      setWantClientAuth =
