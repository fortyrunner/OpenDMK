...
public interface SynchroMessageConnection {
   ...
   *
   * @throws UnsupportedOperationException thrown if the operation is not supported
   *                                       by an implementation.
   * @throws IOException                   if a message could not be sent because of a communication problem.
   */
