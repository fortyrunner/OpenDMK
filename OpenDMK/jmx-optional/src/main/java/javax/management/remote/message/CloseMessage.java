...
public class CloseMessage implements Message {
   ...
   *
   * @param msg a user specific message explaining why the connection
   *            was closed by the remote side
   */
   ...
   * remote side.
   *
   * @return a message explaining why the connection was closed by
   * the remote side.
   */
