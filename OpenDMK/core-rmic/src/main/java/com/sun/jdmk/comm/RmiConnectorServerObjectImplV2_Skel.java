  ...
  public void dispatch(java.rmi.Remote obj, java.rmi.server.RemoteCall call, int opnum, long hash)
    ...
    if (opnum < 0) {
      if (hash == 2440010322598766993L) {
        ...
        if (hash == 2169275250666070156L) {
          opnum = 1;
        } else {
          if (hash == 5370333889440009947L) {
            opnum = 2;
          } else {
            if (hash == 977318789919612498L) {
              opnum = 3;
            } else {
              if (hash == -410295849957453740L) {
                opnum = 4;
              } else {
                if (hash == 3099299699664743513L) {
                  opnum = 5;
                } else {
                  if (hash == 512409007936098290L) {
                    opnum = 6;
                  } else {
                    if (hash == -3425292753612071307L) {
                      opnum = 7;
                    } else {
                      if (hash == 1921649590489468780L) {
                        opnum = 8;
                      } else {
                        if (hash == 4858459067333490289L) {
                          opnum = 9;
                        } else {
                          if (hash == 6940807516347053750L) {
                            opnum = 10;
                          } else {
                            if (hash == 260369099243055722L) {
                              opnum = 11;
                            } else {
                              if (hash == -7609211420371661371L) {
                                opnum = 12;
                              } else {
                                if (hash == 436319371904843320L) {
                                  opnum = 13;
                                } else {
                                  if (hash == 3187052459013828740L) {
                                    opnum = 14;
                                  } else {
                                    if (hash == 7107001389539938448L) {
                                      opnum = 15;
                                    } else {
                                      if (hash == -2341243041480682483L) {
                                        opnum = 16;
                                      } else {
                                        if (hash == 771897399327456434L) {
                                          opnum = 17;
                                        } else {
                                          if (hash == -1801622868570705949L) {
                                            opnum = 18;
                                          } else {
                                            if (hash == 1828313826367654983L) {
                                              opnum = 19;
                                            } else {
