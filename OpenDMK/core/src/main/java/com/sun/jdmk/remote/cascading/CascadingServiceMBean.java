...
public interface CascadingServiceMBean {
   ...
   * </pre>
   **/
  ObjectName CASCADING_SERVICE_DEFAULT_NAME =
    new Object() {
   ...
   **/
  String CASCADING_FAILED_NOTIFICATION =
   ...
   * @see #unmount
   **/
  String CASCADING_STOPPED_NOTIFICATION =
   ...
   * @throws NullPointerException           if sourceURL is <tt>null</tt>. See
   *                                        {@link JMXConnectorFactory#connect
   *                                        JMXConnectorFactory.connect}.
   * @throws IOException                    if the connector client or the connection to
   ...
   * @throws SecurityException              if the connection with the source
   *                                        MBeanServer cannot be made for security reasons. See
   *                                        {@link JMXConnectorFactory#connect
   *                                        JMXConnectorFactory.connect}.
   * @throws InstanceAlreadyExistsException if a name conflict is
   *                                        detected while performing the mount operation.
   *                                        See {@link CascadingAgentMBean#start(boolean)
   *                                        CascadingAgentMBean.start}.
   **/
  String mount(JMXServiceURL sourceURL, Map sourceMap,
