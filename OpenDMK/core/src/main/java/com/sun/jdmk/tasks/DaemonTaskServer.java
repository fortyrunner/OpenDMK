...
public class DaemonTaskServer implements TaskServer {
  ...
  private final transient LinkedList list = new LinkedList();
   ...
   * @throws InterruptedException if cancel is interrupted.
   **/
   ...
   *
   * @throws InterruptedException if stop is interrupted.
   **/
  public void stop() throws InterruptedException {
    final Thread t;
    //trace.send("Stopping...");
    synchronized (this) {
      if (isOn() == false && thread == null) {
        return;
      }
      t = thread;
      on = false;
   ...
   *
   * @throws IllegalStateException if the DaemonTaskServer is running.
   **/
   ...
   *
   * @throws IllegalStateException if the DaemonTaskServer is terminated.
   **/
  public void start() {
