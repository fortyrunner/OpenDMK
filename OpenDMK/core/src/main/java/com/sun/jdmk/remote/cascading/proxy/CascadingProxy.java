...
public class CascadingProxy
   ...
   * @throws IOException if no <tt>MBeanServerConnection</tt> can be
   *                     obtained.
   **/
   ...
   * @throws MBeanException               Wraps a <tt>java.lang.Exception</tt> thrown by the MBean's getter.
   * @throws ReflectionException          Wraps a <tt>java.lang.Exception</tt>
   *                                      thrown while trying to invoke the getter.
   * @throws UndeclaredThrowableException if an
   ...
   * @throws MBeanException                 Wraps a <tt>java.lang.Exception</tt> thrown
   ...
   * @throws MBeanException               Wraps a <tt>java.lang.Exception</tt>
   ...
   * @throws IllegalArgumentException if the parameter <var>name</var>
   *                                  is <tt>null</tt>
