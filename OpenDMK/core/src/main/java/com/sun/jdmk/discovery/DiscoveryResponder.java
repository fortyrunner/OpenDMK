...
public class DiscoveryResponder
   ...
   * @throws java.lang.Exception This exception should be caught by the
  ...
  public ObjectName preRegister(MBeanServer server, ObjectName name)
    ...
    // ----------------
    spy = name.getKeyProperty(SPY);

    // ----------------
    // Should we Send event
    // ----------------
    noEvent = name.getKeyProperty("PRIVATE_NO_EVENT");
   ...
   * @throws java.lang.IllegalArgumentException The input ttl value is not
  ...
  private static final int defaultMulticastPort = 9000;
  private static final String defaultMulticastGroup = "224.224.224.224";
