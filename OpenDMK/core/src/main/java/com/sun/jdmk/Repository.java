...
public interface Repository {
   ...
   * @throws InstanceAlreadyExistsException The MBean is already stored in the repository.
   */
   ...
   * @throws InstanceNotFoundException The MBean does not exist in the repository.
   */
