...
interface RmiConnectorServerObject extends Remote {
   ...
   */
  void unregisterMBean(ObjectName name) throws InstanceNotFoundException, MBeanRegistrationException, RemoteException;
   ...
   */
  ObjectInstance getObjectInstance(ObjectName name) throws InstanceNotFoundException, RemoteException;
   ...
   * @throws RemoteException See java.rmi.RemoteException.
   */
  java.util.Set queryMBeans(ObjectName name, QueryExp query) throws RemoteException;
   ...
   * @throws RemoteException           See java.rmi.RemoteException.
   * @throws InstanceNotFoundException
   * @throws ReflectionException       An exception occurred trying to
   ...
   */
  Object invoke(ObjectName name, String actionName, Object params[], String signature[])
