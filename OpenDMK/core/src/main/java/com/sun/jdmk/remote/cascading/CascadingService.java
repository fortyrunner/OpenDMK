...
public class CascadingService implements CascadingServiceMBean,
  ...
  public CascadingService(MBeanServer targetMBS) {
    ...
    this.listener = this::handleJMXCN;
   ...
   * @throws IllegalArgumentException if no target <tt>MBeanServer</tt>
   ...
   * this object.
   * @throws IOException If an IOException occurs while creating
   *                     the cascading agent.
   **/
  // protected
   ...
   *                     will be returned by the {@link #mount mount} operation.
   *                     <p>
   * @throws IOException if the JMXConnector cannot be connected -
   ...
   *                        <p>
   * @throws IOException If an IOException exception occurs while
