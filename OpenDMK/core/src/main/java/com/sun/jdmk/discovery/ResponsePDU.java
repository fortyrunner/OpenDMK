...
// Private variables
// ----------------------------------------------------------
  private final Hashtable objectList = new Hashtable();
...
// ----------------------------------------------------------
  ...
  public String printState() {
    ...
    if (getEvent() == true) {
      String s = null;
      if (getAgentState() == DiscoveryMonitor.ONLINE) {
        s = "ONLINE";
      }
      if (getAgentState() == DiscoveryMonitor.OFFLINE) {
        s = "OFFLINE";
      }
      if (getAgentState() == DiscoveryMonitor.STOPPING) {
        s = "STOPPING";
      }
