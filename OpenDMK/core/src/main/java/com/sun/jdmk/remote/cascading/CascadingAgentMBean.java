...
public interface CascadingAgentMBean {
   ...
   * been cascaded as a result of this invocation.</p>
   *
   * @throws IOException           if cascading couldn't be established.
   * @throws IllegalStateException if this cascading agent is not in
   ...
   * </p>
   *
   * @throws IOException           if cascading couldn't be stopped.
   * @throws IllegalStateException if this cascading agent is not in
