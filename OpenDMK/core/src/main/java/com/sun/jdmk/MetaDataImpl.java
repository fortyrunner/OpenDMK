...
public class MetaDataImpl extends DynamicMetaDataImpl {
   ...
   */
  private static final java.util.Hashtable mbeanInfoCache =
    new java.util.Hashtable();

  /**
   * Cache of MBean Interface objects.
   */
  private static final java.util.Hashtable mbeanInterfaceCache =
    new java.util.Hashtable();
   ...
   *                                    introspection.
   * @throws NotCompliantMBeanException if the MBean class is not
   *                                    MBean compliant.
   */
  ...
  public AttributeList getAttributes(Object instance, String[] attributes)
    ...
    for (final String elmt : attributes) {
      try {
        final Object value =
