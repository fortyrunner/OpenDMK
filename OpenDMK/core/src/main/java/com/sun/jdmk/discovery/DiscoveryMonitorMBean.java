...
public interface DiscoveryMonitorMBean {
   ...
   */
  void setMulticastGroup(String multicastGroup) throws java.lang.IllegalStateException;
   ...
   *                                         the <CODE>DiscoveryMonitor</CODE> was ONLINE or STARTING.
   */
  void setMulticastPort(int multicastPort) throws java.lang.IllegalStateException;
