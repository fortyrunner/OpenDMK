...
public class DefaultMBeanInterceptor implements MBeanServerInterceptor {
  ...
  public ObjectInstance createMBean(String className, ObjectName name,
    ...
    return createMBean(className, name, loaderName, null,
      null);
  }
  ...
  public ObjectInstance getObjectInstance(ObjectName name)
    ...
    } catch (IntrospectionException | NotCompliantMBeanException x) {
  ...
  public Set queryNames(ObjectName name, QueryExp query) {
    ...
    for (Object no : nos) {
      final ObjectInstance oi = (ObjectInstance) no;
  ...
  public String[] getDomains() {
    ...
    for (Object name : names) {
      final ObjectInstance oi = (ObjectInstance) name;
   ...
   * @throws NotCompliantMBeanException if the <code>object</code>
  ...
  protected ObjectInstance makeObjectInstance(String className,
    ...
    if (object instanceof DynamicMBean) {
      ...
      } catch (IntrospectionException | JMRuntimeException x) {
