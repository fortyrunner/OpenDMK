...
public interface RemoteMBeanServer extends ProxyHandler, ClientNotificationHandler {
   ...
   */
  void connect(ConnectorAddress MBeanServerAddress);
   ...
   * @throws ReflectionException            Wraps the <CODE>java.lang.Exception</CODE> that occurred when trying
   ...
   * @return An <CODE>ObjectInstance</CODE> representing the newly created MBean.
   * @throws ReflectionException            Wraps the <CODE>java.lang.Exception</CODE> that occurred trying to invoke the MBean's
   *                                        constructor.
   * @throws InstanceAlreadyExistsException The MBean is already under the control of the MBean server.
   * @throws MBeanRegistrationException     The <CODE>preRegister</CODE> (<CODE>MBeanRegistration</CODE>
   *                                        interface) method of the MBean has thrown an exception. The MBean will not be registered.
