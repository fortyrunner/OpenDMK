...
public interface MetaData {
   ...
   */
  void testCompliance(Class c) throws NotCompliantMBeanException;

  /**
   * Invokes the  preRegister method  of an MBean that implements
   * MBeanRegistration
   */
  ObjectName preRegisterInvoker(Object moi, ObjectName name,
                                MBeanServer mbs)
   ...
   *                                    getter.
   * @throws ReflectionException        Wraps a java.lang.Exception thrown
   ...
   * @throws AttributeNotFoundException     The specified attribute is
   *                                        not accessible in the MBean.
   * @throws InvalidAttributeValueException The specified value for
   ...
   */
  Object invoke(Object instance, String operationName,
