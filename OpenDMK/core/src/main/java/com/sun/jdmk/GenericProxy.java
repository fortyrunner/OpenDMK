...
public class GenericProxy implements Proxy {
   ...
   * @throws ProxyMBeanInstantiationException The <CODE>ProxyMBean</CODE> Metadata Service could not be instantiated.
   * @throws InstanceNotFoundException        The MBean specified is not registered in the MBean server.
   * @throws ReflectionException              Wraps a <CODE>java.lang.Exception</CODE> thrown while trying to invoke the introspect
   *                                          method.
   ...
   * @throws ReflectionException            Wraps a <CODE>java.lang.Exception</CODE> thrown while trying to invoke the setter.
   */
