...
interface RmiConnectorServerObjectV2 extends Remote {
   ...
   */
  void unregisterMBean(ObjectName name, OperationContext context)
   ...
   * @throws RemoteException See java.rmi.RemoteException.
   */
  boolean isRegistered(ObjectName name, OperationContext context)
    throws RemoteException;
   ...
   * @throws RemoteException See java.rmi.RemoteException.
   */
  Integer getMBeanCount(OperationContext context)
    throws RemoteException;
   ...
   * @throws RemoteException See java.rmi.RemoteException.
   */
  String getDefaultDomain(OperationContext context)
    throws RemoteException;
   ...
   */
  Object invoke(ObjectName name, String actionName, Object params[],
   ...
   */
  MBeanInfo getMBeanInfo(ObjectName name, OperationContext context)
   ...
   * Notifications
   */
  Object[] remoteRequest(int opType, Object[] params,
                         OperationContext context)
    throws Exception;
   ...
   * HeartBeat
   */
  String pingHeartBeatServer(String sessionId, int period,
