...
public class MBeanServerInterceptorWrapper implements MBeanServerInterceptor {
  ...
  public interface Controller {
     ...
     * </li></ul>
     **/
    int CREATE = 0, REGISTER = 1, UNREGISTER = 2,
     ...
     * needed.
     * @throws JMRuntimeException if a runtime exception is thrown,
     ...
     **/
    Object beginOperation(final int operationType,
     ...
     *                      (like <i>getMBeanCount</i>).
     **/
    void endOperation(Object handle, final int operationType,
                      final String operationName,
                      final ObjectName mbeanName);
  }
   ...
   *
   * @throws IllegalArgumentException if the wrapped MBeanServerInterceptor
   *                                  is null.
   **/
