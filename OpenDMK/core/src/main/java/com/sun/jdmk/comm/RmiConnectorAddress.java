...
public class RmiConnectorAddress implements ConnectorAddress {
   ...
   * The RMI port number
   */
  private final int defaultPort = com.sun.jdmk.ServiceName.RMI_CONNECTOR_PORT;
  private int port = defaultPort;

  /**
   * The RMI connector server service name
   */
  private final String defaultServiceName = com.sun.jdmk.ServiceName.RMI_CONNECTOR_SERVER;
