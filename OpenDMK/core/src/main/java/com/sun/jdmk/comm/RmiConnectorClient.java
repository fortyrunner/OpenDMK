...
public class RmiConnectorClient
   ...
   * @throws Exception thrown if an exception appears in the server side.
   */
...
//          throw (javax.management.JMRuntimeException) e.detail ;
   ...
   * @throws IllegalArgumentException Thrown if the mode is not equal to
   ...
   * @throws CommunicationException if the context cannot be set for
   ...
   * @throws CommunicationException   The <CODE>RemoteMBeanServer</CODE> was already connected or a problem was
   ...
   * @throws ReflectionException            Wraps the exception that occurred when trying to invoke the MBean's constructor.
   * @throws InstanceAlreadyExistsException The MBean is already under the control of the MBean server.
   ...
   * @throws MBeanException                 Wraps an exception thrown by the MBean's constructor.
   * @throws NotCompliantMBeanException     This class is not a JMX compliant MBean.
   * @throws InstanceNotFoundException      The specified loader is not registered in the <CODE>MBeanServer</CODE>.
   * @throws CommunicationException         The RMI Connector Client is not connected to RMI Connector Server
   *                                        or a problem was encountered in the connection to the RMI Connector Server.
   */
  @Override
   ...
   * @return An <CODE>ObjectInstance</CODE> representing the newly created MBean.
   * @throws ReflectionException            Wraps the exception that occurred when trying to invoke the MBean's
   *                                        constructor.
   * @throws InstanceAlreadyExistsException The MBean is already under the control of the MBean server.
   * @throws MBeanRegistrationException     The <CODE>preRegister</CODE> (<CODE>MBeanRegistration</CODE>
   *                                        interface) method of the MBean has thrown an exception. The MBean will not be registered.
   ...
   * @throws InstanceNotFoundException  The specified MBean is not registered in the <CODE>MBeanServer</CODE>.
   ...
   * @throws RuntimeOperationsException Wraps an IllegalArgumentException: The object name in parameter is null.
   * @throws CommunicationException     The RMI Connector Client is not connected to RMI Connector Server
   *                                    or a problem was encountered in the connection to the RMI Connector Server.
   */
  @Override
   ...
   * @throws InstanceNotFoundException  The specified MBean is not registered in the <CODE>MBeanServer</CODE>.
   * @throws ReflectionException        An exception occurred when trying to invoke the getAttributes of a Dynamic MBean.
   * @throws CommunicationException     The RMI Connector Client is not connected to RMI Connector Server
   *                                    or a problem was encountered in the connection to the RMI Connector Server.
   */
  @Override
   ...
   * @throws InstanceNotFoundExceptionThe MBean specified is not registered in the MBean server.
   * @throws ReflectionException          An exception occurred when trying to invoke the getAttributes of a Dynamic MBean.
   * @throws CommunicationException       The RMI Connector Client is not connected to RMI Connector Server
   *                                      or a problem was encountered in the connection to the RMI Connector Server.
   */
   ...
   * The value of the attributes can be any Java object that is <CODE>serializable</CODE>.
   * @throws InstanceNotFoundException The MBean specified is not registered in the MBean server.
   * @throws ReflectionException       An exception occurred when trying to invoke the setAttributes of a Dynamic MBean.
   * @throws CommunicationException    The RMI Connector Client is not connected to RMI Connector Server
   *                                   or a problem was encountered in the connection to the RMI Connector Server.
   */
  @Override
   ...
   * @throws ReflectionException       Wraps an <CODE>java.lang.Exception</CODE> thrown while
  ...
  private final String localClassName = "com.sun.jdmk.comm.RmiConnectorClient";
  ...
  private class NotificationHandlerInternal implements ClientNotificationHandlerInternal {
     ...
     * will allow the communication from the agent side to client side.
     *
     * @throws CommunicationException thrown if the communication between the server and
     *                                the client is failed.
     * @throws RemoteRuntimeException thrown if an exception appears in the server side.
     */
    @Override
    ...
    private final RmiConnectorClient connector;
  }
   ...
   */
  private final transient java.util.Hashtable proxyHandles = new java.util.Hashtable();
  private final transient java.util.Hashtable genericHandles = new java.util.Hashtable();
