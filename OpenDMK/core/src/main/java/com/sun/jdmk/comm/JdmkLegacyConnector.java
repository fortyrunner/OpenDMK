...
public interface JdmkLegacyConnector {
   ...
   */
  String HTTP_CONNECTOR = "jdmk-http";
   ...
   */
  String HTTPS_CONNECTOR = "jdmk-https";
   ...
   */
  String HTTP_SERVER_AUTHINFO_LIST =
   ...
   */
  String HTTP_SERVER_LOCAL_ADDRESS =
   ...
   */
  String HTTPS_SERVER_NEED_CLIENT_AUTH =
