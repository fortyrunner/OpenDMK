...
public abstract class ForwardingMBeanServerInterceptor implements MBeanServerInterceptor {
   ...
   * @throws NullPointerException      if <code>next</code> is null.
   * @throws InterceptorCycleException if <code>next</code> is
   ...
   *             inserted.
   * @throws NullPointerException      if <code>lmbs</code> is null.
   * @throws InterceptorCycleException if <code>this</code> is
   ...
   * @param lmbs the MBean server where this interceptor is to be
   *             removed.
   * @throws InterceptorNotPresentException if this {@link
   *                                        ForwardingMBeanServerInterceptor} is not in the chain of
   *                                        interceptors for <code>lmbs</code>.
   * @throws InterceptorCycleException      if a cycle is detected
