...
//             outputStream.flush();
  ...
  public void connect(ConnectorAddress mbeanServerAddress) {
    ...
    if (connected == true) {
      ...
      } catch (UnauthorizedSecurityException | CommunicationException e) {
        throw e;
      } catch (Exception e) {
   ...
   * @throws CommunicationException         The connector client is not connected to connector server
  ...
  public void unregisterMBean(ObjectName name) throws InstanceNotFoundException, MBeanRegistrationException {
    ...
    } catch (InstanceNotFoundException | RuntimeException | MBeanRegistrationException e) {
      throw e;
    } catch (Exception e) {
      throw new CommunicationException(e);
    }
   ...
   * @throws InstanceNotFoundException     The specified MBean is not registered in the MBean server.
   * @throws ReflectionException           Wraps an exception thrown while trying to instantiate
  ...
  public Object getAttribute(ObjectName name, String attribute)
    ...
    } catch (MBeanException | RuntimeException | ReflectionException | InstanceNotFoundException | AttributeNotFoundException e) {
      throw e;
    } catch (Exception e) {
      throw new CommunicationException(e);
    }
   ...
   * @throws InstanceNotFoundException      The specified MBean is not registered in the MBean server.
   * @throws AttributeNotFoundException     The specified attribute is not accessible in the MBean.
   * @throws InvalidAttributeValueException The specified value for the attribute is not valid.
  ...
  public void setAttribute(ObjectName name, Attribute attribute)
    ...
    try {
      invokeRemoteOperation(opList);
    } catch (InstanceNotFoundException | RuntimeException | ReflectionException | MBeanException | InvalidAttributeValueException | AttributeNotFoundException e) {
      throw e;
    } catch (Exception e) {
      throw new CommunicationException(e);
    }
  ...
  public Object invoke(ObjectName name, String methodName, Object arguments[], String signature[])
    ...
    try {
      return invokeRemoteOperation(opList);
    } catch (InstanceNotFoundException | RuntimeException | ReflectionException | MBeanException e) {
      throw e;
    } catch (Exception e) {
      throw new CommunicationException(e);
    }
   ...
   * @throws ReflectionException           Wraps a java.lang.Exception thrown while trying
  ...
  public MBeanInfo getMBeanInfo(ObjectName name)
    ...
    } catch (InstanceNotFoundException | RuntimeException | ReflectionException | IntrospectionException e) {
      throw e;
    } catch (Exception e) {
      throw new CommunicationException(e);
    }
  ...
  Object[] remoteRequest(int opType, Object[] params) throws Exception {
    ...
    } catch (InstanceNotFoundException | RuntimeException | ListenerNotFoundException e) {
      throw e;
    } catch (Exception e) {
      throw new CommunicationException(e);
    }
  ...
  private class NotificationHandlerInternal implements ClientNotificationHandlerInternal {
    ...
    private final GenericHttpConnectorClient connector;
  }
  ...
  private Object invokeRemoteOperation(Object[] opList) throws Exception {
    ...
    try (InputStream in = sendHttp(opList, false)) {
   ...
   * Proxies
   */
  private final transient Hashtable proxyHandles = new Hashtable();
  private final transient Hashtable genericHandles = new Hashtable();
